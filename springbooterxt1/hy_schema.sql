...
INSERT INTO `hy_customer` (`id`,`addtime`,`name`,`contact`,`phone`,`industry`,`biztype`,`scale`,`manager_id`,`manager_name`,`follow_status`,`intention`,`tags`,`preference`,`avatar`,`last_follow_time`,`deal_count`,`unpaid_count`,`unpaid_amount`,`satisfaction`,`selected_count`,`shot_count`,`delivered_count`,`published_count`,`remain_count`,`publish_days`,`publish_deadline`) VALUES
 (6001,'2026-05-01 09:00:00','林女士·山城火锅','林女士','138****1123','餐饮','火锅','连锁',1002,'阿杰','跟进中','高','重点客户,长期合作','硬广,随过程,真实烟火气','upload/studio_cover_1.jpg','2026-06-20 10:30:00',3,2,58600.00,5,15,10,8,4,4,8,'6月28日'),
 (6002,'2026-05-02 09:00:00','王先生·名筑瓷砖','王经理','137****5566','建筑','建材','区域',1004,'张雨桐','已成交','中','成长客户,活跃品牌','品牌形象','upload/studio_cover_4.jpg','2026-06-12 16:45:00',5,0,0,5,12,8,6,9,9,10,'7月10日'),
 (6003,'2026-05-03 09:00:00','启星口才·教培','刘老师','135****8899','企业','文化教育','单店',1003,'王旭','跟进中','高','潜力客户','讲故事,说观点','upload/studio_cover_8.jpg','2026-06-18 11:05:00',1,1,21400.00,4,18,12,8,5,18,30,'8月12日'),
 (6004,'2026-05-04 09:00:00','陈老板·奶茶店','陈老板','136****7788','餐饮','奶茶','单店',1002,'阿杰','待付款','中','新客户','随过程','upload/studio_cover_3.jpg','2026-06-15 09:00:00',0,1,32800.00,4,7,3,0,0,0,0,NULL),
 (6005,'2026-05-05 09:00:00','杭州葛九香火锅','周总','138****1111','餐饮','火锅','连锁',1004,'张雨桐','跟进中','高','重点客户','硬广,真实烟火气','upload/studio_cover_1.jpg','2026-05-31 10:30:00',3,2,58600.00,5,10,6,3,2,5,8,NULL);
...
INSERT INTO `hy_material` (`id`,`addtime`,`title`,`cover`,`video`,`duration`,`industry_big`,`industry_sub`,`content_type`,`tags`,`like_count`,`dislike_count`,`favorite_count`,`view_count`,`used_count`,`heat`,`status`,`recommend`,`source`) VALUES
 (7001,'2026-05-20 10:30:00','3秒上菜挑战','upload/studio_cover_1.jpg',NULL,32,'餐饮','火锅','硬广','硬广,强节奏',2438,210,168,2438,1025,98,'上架',1,NULL),
 (7002,'2026-05-21 09:18:00','锅底煎制','upload/studio_cover_2.jpg',NULL,19,'餐饮','火锅','厨过程','厨过程',1865,231,132,1865,789,80,'上架',0,NULL),
 (7003,'2026-05-22 16:45:00','牛肉知识','upload/studio_cover_5.jpg',NULL,28,'餐饮','火锅','教知识','教知识,料方',1245,312,213,1245,560,70,'上架',0,NULL),
 (7004,'2026-05-23 11:10:00','老板观点','upload/studio_cover_6.jpg',NULL,30,'餐饮','火锅','说观点','说观点',1204,197,97,1204,455,60,'上架',1,NULL),
 (7005,'2026-05-24 09:05:00','门店日常','upload/studio_cover_7.jpg',NULL,24,'餐饮','火锅','讲故事','讲故事',876,248,76,876,410,55,'上架',0,NULL),
 (7006,'2026-05-25 14:00:00','食材准备','upload/studio_cover_3.jpg',NULL,26,'餐饮','火锅','厨过程','厨过程',1183,215,131,1183,612,65,'上架',0,NULL),
 (7007,'2026-05-26 10:00:00','秘制锅底炒料','upload/studio_cover_4.jpg',NULL,31,'餐饮','火锅','厨过程','厨过程',940,120,88,940,300,50,'上架',0,NULL),
 (7008,'2026-05-27 10:00:00','现切鲜牛肉','upload/studio_cover_1.jpg',NULL,26,'餐饮','火锅','硬广','硬广',1320,140,120,1320,520,62,'上架',0,NULL);
