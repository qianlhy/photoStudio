...
public class UserBasedCollaborativeFiltering {
    ...
    private final Map<String, List<String>> itemUsers;
    private final Map<String, Integer> userIndex;
    private final Map<Integer, String> indexUser;
    private final Long[][] sparseMatrix;
